		...
		<footer className="bg-primary my-auto pt-20 pb-20 pl-4 pr-4">
			<div className="mx-auto max-w-7xl flex flex-col lg:flex-row gap-12 lg:gap-0 lg:justify-between">
				<div id="footer-contact" className="flex flex-col gap-4">
					...
					<p className="text-secondary hover:underline cursor-pointer">contact@cryptocove.com</p>
					<div>
				...
				<section id="footer-products" className="flex flex-col gap-4">
					...
					<ul className="flex flex-col gap-2">
						<li className="text-secondary cursor-pointer hover:underline">Spot</li>
						<li className="text-secondary cursor-pointer hover:underline">Inverse Perpetual</li>
						<li className="text-secondary cursor-pointer hover:underline">USDT Perpetual</li>
						<li className="text-secondary cursor-pointer hover:underline">Exchange</li>
						<li className="text-secondary cursor-pointer hover:underline">Launchpad</li>
						<li className="text-secondary cursor-pointer hover:underline">Binance Pay</li>
					</ul>
				</section>
				...
				<section id="footer-services" className="flex flex-col gap-4">
					...
					<ul className="flex flex-col gap-2">
						<li className="text-secondary cursor-pointer hover:underline">Buy Crypto</li>
						<li className="text-secondary cursor-pointer hover:underline">Markets</li>
						<li className="text-secondary cursor-pointer hover:underline">Trading Fee</li>
						<li className="text-secondary cursor-pointer hover:underline">Affiliate Program</li>
						<li className="text-secondary cursor-pointer hover:underline">Referrel Program</li>
						<li className="text-secondary cursor-pointer hover:underline">API</li>
					</ul>
				</section>
				...
				<section id="footer-support" className="flex flex-col gap-4">
					...
					<ul className="flex flex-col gap-2">
						<li className="text-secondary cursor-pointer hover:underline">CryptoCove Learn</li>
				...
				<section id="footer-about-us" className="flex flex-col gap-4">
					...
					<ul className="flex flex-col gap-2">
						<li className="text-secondary cursor-pointer hover:underline">About CryptoCove</li>
